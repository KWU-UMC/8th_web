...
const LpDetail = () => {
    ...
    // 좋아요 버튼 클릭 핸들러
    const handleLikeClick = useThrottle(() => {
        if (isLiked) {
    ...
    const handleCommentOrderChange = useThrottle((order: 'asc' | 'desc') => {
        setCommentOrder(order);
    }, 500); // 0.5초 동안 한 번만 실행되도록 설정
            ...
            <div className="bg-[#23232b] rounded-2xl shadow-xl p-8 w-full max-w-2xl flex flex-col items-center relative">
                ...
                <div className="flex items-center w-full justify-between mb-2">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-white font-semibold">{lp.authorId}</span>
                    </div>
