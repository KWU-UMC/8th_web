...
import { modify_lp } from "../apis/lpapi";
import { useParams } from "react-router-dom";

interface ModifylpmodalI {
  setIsModifyModalOpen: React.Dispatch<SetStateAction<boolean>>;
}

export default function Modifylpmodal({
